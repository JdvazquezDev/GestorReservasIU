...
CREATE TABLE `ESPACIO` (
  ...
  `DISPONIBILIDAD` enum('true','false') DEFAULT 'false' NOT NULL,
  `HORARIOINICIODISPONIBLE` time,
  `HORARIOFINDISPONIBLE` time
...
CREATE TABLE `RESERVA` (
  ...
  `CODESPACIO` varchar(10) NOT NULL,
  `LOGINCREADOR` varchar(15) NOT NULL,
  `FECHARESERVA` date NOT NULL,
  `HORARIOINICIORESERVA` time NOT NULL,
  `HORARIOFINRESERVA` time NOT NULL,
  `USORESERVA` varchar(100) NOT NULL,
  `VERIFICADA` enum('true','false') DEFAULT 'false' NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
